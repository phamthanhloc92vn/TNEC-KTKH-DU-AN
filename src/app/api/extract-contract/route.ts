...
**BƯỚC 1 — QUÉT MỤC LỤC (ảnh 1-3 đầu tiên):**
  Tìm bảng "MỤC LỤC" / "DANH MỤC" trong những ảnh đầu tiên.
  Xác định số Điều/Khoản/Chương chứa các từ khóa:
  - "Giá trị hợp đồng" → Tìm ra Điều mấy? (VD: Điều 4)
  - "Tạm ứng", "Thanh toán" → Tìm ra Điều mấy? (VD: Điều 9, 9.3)
  - "Thành phần liên danh", "Tỷ lệ" → Tìm ra Điều mấy?

**BƯỚC 2 — ĐỊNH VỊ TRANG (toàn bộ ảnh):**
  Từ số Điều thu thập được ở Bước 1, tìm đến đúng các ảnh chứa chúng.
  Ưu tiên đọc kỹ các phần đó thay vì đọc đều mọi trang.

**BƯỚC 3 — TRÍCH XUẤT CHÍNH XÁC:**
  Lấy số liệu từ các ảnh đã định vị.
